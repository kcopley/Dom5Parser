...
namespace Dom5Edit.Entities
{
    public class Item : IDEntity
    {
        ...
        static Item()
        {
            ...
            _propertyMap.Add(Command.COPYITEM, ItemIDRef.Create);
            _propertyMap.Add(Command.COPYSPR, ItemIDRef.Create);
            ...
            _propertyMap.Add(Command.SPELL, SpellIDRef.Create);
            _propertyMap.Add(Command.AUTOSPELL, SpellIDRef.Create);
